...
'''
    @brief Function to compute object pose. Basically, the block is "sliced" at a specific height to find the 2
      useful points:
    ...
    @param point cloud and the block
    @retval yaw angle (radiant)
'''
...
def choose_side(x_min, y_min, y_max):
    '''
    @brief function calculate longest side of the block in order to compute the angle along it
    @param the three points of interest of the block
    '''
